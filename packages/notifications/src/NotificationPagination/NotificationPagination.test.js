...
describe('Notification Pagination component', () => {
  ...
  it('render should contain correct items', () => {
    ...
    expect(wrapper.find('.pf-v6-c-pagination.pf-m-bottom').length).toBe(1);
    expect(wrapper.find('.pf-v6-c-pagination__nav').length).toBe(1);
  });
  ...
  it('should call next page action', () => {
    ...
    wrapper.find('.pf-v6-c-pagination__nav button').last().simulate('click');
