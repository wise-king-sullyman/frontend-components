...
describe('PrimaryToolbar', () => {
  ...
  describe('API', () => {
    it('should call DESC sort', () => {
      ...
      wrapper.find('.ins-c-primary-toolbar__actions button.pf-v6-c-menu-toggle').first().simulate('click');
      wrapper.update();
      wrapper.find('.ins-c-primary-toolbar__overflow-actions.pf-v6-c-menu__item').first().simulate('click');
    ...
    it('should call ASC sort', () => {
      ...
      wrapper.find('.ins-c-primary-toolbar__actions button.pf-v6-c-menu-toggle').first().simulate('click');
      wrapper.update();
      wrapper.find('.ins-c-primary-toolbar__overflow-actions.pf-v6-c-menu__item').at(1).simulate('click');
      expect(config.sortByConfig.onSortChange).toHaveBeenCalled();
